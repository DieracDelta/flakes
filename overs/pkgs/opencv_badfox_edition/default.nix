{ lib, stdenv, fetchurl, fetchFromGitHub, fetchpatch, cmake, pkgconfig, unzip
, zlib, pcre, hdf5, glog, boost, gflags, protobuf, config
...
, enableCuda ? (true) && stdenv.hostPlatform.isx86_64, cudatoolkit_11
, nvidia-optical-flow-sdk

, enableCudnn ? true, cudnn_cudatoolkit_11, enableUnfree ? true
, enableIpp ? true, enablePython ? true, pythonPackages, python38Full
, enableGtk2 ? true, gtk2, enableGtk3 ? true, gtk3, enableVtk ? true, vtk
, enableFfmpeg ? true, ffmpeg_3, enableGStreamer ? true, gst_all_1
, enableTesseract ? true, tesseract, leptonica, enableTbb ? true, tbb
, enableOvis ? true, ogre, enableGPhoto2 ? true, libgphoto2, enableDC1394 ? true
, libdc1394, enableDocs ? true, doxygen, graphviz-nox
...
in stdenv.mkDerivation {
  ...
  buildInputs = [ zlib pcre hdf5 glog boost gflags protobuf ]
    ++ lib.optional enablePython python38Full ++ lib.optional enableGtk2 gtk2
    ++ lib.optional enableGtk3 gtk3 ++ lib.optional enableVtk vtk
    ++ lib.optional enableJPEG libjpeg ++ lib.optional enablePNG libpng
    ++ lib.optional enableTIFF libtiff ++ lib.optional enableWebP libwebp
    ++ lib.optionals enableEXR [ openexr ilmbase ]
    ++ lib.optional enableFfmpeg ffmpeg_3 ++ lib.optionals enableGStreamer
    ...
    ++ lib.optionals enableCuda [ cudatoolkit_11 nvidia-optical-flow-sdk ]
    ++ lib.optionals enableCudnn [ cudnn_cudatoolkit_11 ]
  ...
  cmakeFlags = [
    ...
    "-DCUDA_FAST_MATH=ON"
    "-DCUDA_HOST_COMPILER=${cudatoolkit_11.cc}/bin/cc"
