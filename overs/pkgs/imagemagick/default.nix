...
, lcms2, openexr, libpng, librsvg, libtiff, liblqr1, libxml2, openjpeg, libwebp, fftw, libheif, libde265
}:
...
stdenv.mkDerivation {
  ...
  configureFlags =
    ...
    ++ lib.optional (liblqr1 != null) [ "--with-lqr=yes" ] # enable liquid rescale
    ;
  ...
  buildInputs =
    ...
    ++ lib.optionals (!stdenv.hostPlatform.isMinGW)
      [ openexr librsvg openjpeg liblqr1];
